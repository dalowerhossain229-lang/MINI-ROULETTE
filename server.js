...
// 🎡 ওরিজিনাল মিনি রুলেটের ১৩টি ঘর বিন্যাস (ইন্টারন্যাশনাল স্ট্যান্ডার্ড ম্যাட்ரিক্স ভাই ভাই)
const rouletteNumbers = [0, 2, 4, 6, 8, 10, 12, 11, 9, 7, 5, 3, 1];
const redNumbers = [2, 4, 6, 8, 10, 12]; // লালের ঘরগুলো

// 💰 ১. লাইভ অ্যাকাউন্ট ব্যালেন্স নিয়ে আসার ডেডিকেটেড গেটওয়ে
app.get('/api_callback.php', async (req, res) => {
    // পিএইচপি ক্যাশ ব্যাকআপ রাউট
    ...
    try {
        ...
        while (isLoopActive && loopSafety < 200) {
            ...
            if (userPrediction === winnerColor) {
                finalStatus = "win";
                winMultiplier = (winnerColor === "ZERO") ? 12.00 : 2.00; // জিরো মিললে ১২ গুণ মেগা জ্যাকপট!
            } else {
                finalStatus = "lose";
                winMultiplier = 0.00;
            }
